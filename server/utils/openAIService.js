  ...
  "lessons": [
    {
      ...
      "actual_lesson": "THE LESSON should be between 1000-1200 words",
...
Each lesson must have: be in a way that the user can learn a great deal from it. it should be a comprehensive course. each  actual_lesson content should be between 1000-1200 words
